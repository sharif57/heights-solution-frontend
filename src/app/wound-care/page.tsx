          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              <p className="text-gray-700 font-roboto">
                ...
                especially valuable. We&rsquo;ve been in your shoes. Our team of
                healthcare founders are especially aligned with
                clinician-centered practices, high-potential groups that exceed
                care standards, everything from solo practices with strong
                values and clinicians. Practicing medicine is challenging
                enough. With Heights Solutions as your partner, you can focus on
                what matters: practice and excellent patient experience,
                we&#39;re here to help. What are your goals?
              </p>
            </div>
            ...
            <div>
              <p className="text-gray-700 mb-2">
                As a thank you for connecting, choose one of the following—free
                of charge:
              </p>
              <div className="space-y-2 ml-6">
                ...
                <div className="flex items-start">
                  ...
                  <p className="ml-2 text-gray-700">
                    A strategy session with the founders to discuss operational,
                    financial, or clinical growth goals
                  </p>
                </div>
              </div>
            </div>
            ...
            <div>
              <p className="text-gray-700">
                Together, we can craft innovative solutions that ensure patient
                care and drive sustainable growth for your practice.
              </p>
            </div>
                ...
                <div className="space-y-8">
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="mt-1">Heights Solutions, Houston, Texas</p>
                    </div>
                  </div>
